            ...
            <div class="homepage-body">
                ...
                <div class="home-container">
                    <div class="home-card">
                        ...
                        <p className="p">We provide thousands of exercises to choose from, including videos and instructions that show you how to correctly perform exercises for maximum results.</p>
                        <Link to="/exercises" className="btn">Browse All Exercises</Link>
                    </div>
                    <div class="home-card">
                        <IoIosFitness />
                        <h2>Pre-Made Workout Plans</h2>
                        <p className="p">Our database of workout plans created by fitness experts will provide you with all the tools you need to build and maintain the body you want.</p>
                        <Link to="/workouts" className="btn">Browse Workout Plans</Link>
                    </div>
                    <div class="home-card">
                        <RiUserVoiceLine />
                        <h2>Coaches</h2>
                        <p className="p">Connect with our wide range of speialized coaches for workout and meal planning assiatance. Match with whoever works best for you! Available 24/7 </p>
